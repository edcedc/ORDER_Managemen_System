...
//        picker.setWheelModeEnable(true);
        ...
        picker.setRangeStart(year, mon, day);
        picker.setRangeEnd(year + 10, 12, 1);
...
//        picker.setWheelModeEnable(true);
    ...
    public static void onOptionPicker(Activity act, String title, List<DataBean> listBean, final onOptionPicker listener) {
        List<String> list = new ArrayList<>();
        for (DataBean bean : listBean){
            list.add(bean.getName());
        }
        SinglePicker<String> picker = new SinglePicker<>(act, list);
